...
parcelRequire = (function(modules, cache, entry, globalName) {
...
})(
    {
        ...
        '../node_modules/vue-property-decorator/lib/vue-property-decorator.js': [
            ...
            {
                vue: '../node_modules/vue/dist/vue.runtime.esm.js',
                'vue-class-component': '../node_modules/vue-class-component/dist/vue-class-component.esm.js',
            },
        ],
        ...
        'app.vue': [
                ...
                var App =
                    ...
                    (function(_super) {
                        ...
                        function App() {
                            ...
                            _this.imgList = [
                                'http://img.hao661.com/qq.hao661.com/uploads/allimg/c140912/14105134WT5Z-1EO.jpg',
                                'http://img.hao661.com/qq.hao661.com/uploads/allimg/c140912/14105134X14b0-25B6.jpg',
                                'http://img.hao661.com/qq.hao661.com/uploads/allimg/c140912/14105134X43V0-3M41.jpg',
                                'http://img.hao661.com/qq.hao661.com/uploads/allimg/c140912/14105134XP2P-51423.jpg',
                            ]
                            return _this
                        }

                        App.prototype.openImageTouch = function(arg) {
                            this.$imageTouch({
                        ...
                        App = __decorate([_vuePropertyDecorator.Component], App)
                        return App
                    })(_vuePropertyDecorator.Vue)

                var _default = App
                exports.default = _default
                var $187b86 = exports.default || module.exports

                if (typeof $187b86 === 'function') {
                    $187b86 = $187b86.options
                }
                                            ...
                                            'div',
                                            {
                                                ...
                                                on: {
                                                    click: function($event) {
                                                        return _vm.openImageTouch(index)
                                                    },
                                                },
                                            },
                                            [_c('img', { attrs: { src: item, alt: 'image cover' } })]
                                        )
                                    }),
                                    0
                                ),
                ...
                ;(function() {
                    if (module.hot) {
                        ...
                        if (api.compatible) {
                            module.hot.accept()
                            if (!module.hot.data) {
                                api.createRecord('$187b86', $187b86)
                            } else {
                                api.reload('$187b86', $187b86)
                            }
                        }
            ...
            {
                'vue-property-decorator': '../node_modules/vue-property-decorator/lib/vue-property-decorator.js',
                        ...
                        methods: {
                            ...
                            addRecognizer: function addRecognizer(gesture, options, ref) {
                                ...
                                if (!this.recognizers[gesture]) {
                                    var recognizer = new Hammer[capitalize(mainGesture || gesture)](
        ...
        '../src/image-touch.vue': [
            function(require, module, exports) {
                ...
                _vuePropertyDecorator.Vue.use(_vueTouch.default, {
                    name: 'v-touch',
                })
                ...
                var ImageTouch =
                    ...
                    (function(_super) {
                        ...
                        function ImageTouch() {
                            ...
                            _this.isShow = false
                            _this.activedSub = 0
                            _this.touchWrapLeft = 0
                            _this.pinList = []
                            return _this
                        }

                        Object.defineProperty(ImageTouch.prototype, 'pageWidth', {
                            get: function get() {
                        ...
                        Object.defineProperty(ImageTouch.prototype, 'touchWrapWidth', {
                            get: function get() {
                        ...
                        ImageTouch.prototype.hidden = function() {
                            this.isShow = false
                        }

                        ImageTouch.prototype.show = function(args) {
                            this.isShow = true
                            this.reset()
                        }

                        ImageTouch.prototype.swipeLeft = function() {
                            var max = this.imageList.length - 1
                            this.activedSub = this.activedSub === max ? max : ++this.activedSub
                            this.touchWrapLeft = -(this.pageWidth * this.activedSub)
                        }

                        ImageTouch.prototype.swipeRight = function() {
                            this.activedSub = !this.activedSub ? 0 : --this.activedSub
                            this.touchWrapLeft = -(this.pageWidth * this.activedSub)
                        }

                        ImageTouch.prototype.pinchMove = function(e) {
                            this.$set(this.pinList, this.activedSub, e.scale.toFixed(2))
                        }

                        ImageTouch.prototype.pinchEnd = function(e) {
                            var scale = e.scale

                            var _scale = scale < 1 ? 1 : scale.toFixed(2)

                            this.$set(this.pinList, this.activedSub, _scale)
                        }

                        ImageTouch.prototype.panMove = function(e) {
                            var additionalEvent = e.additionalEvent,
                                distance = e.distance,
                                velocity = e.velocity
                        ...
                        ImageTouch.prototype.panEnd = function(e) {
                            var deltaX = e.deltaX,
                                distance = e.distance,
                                velocity = e.velocity
                            var isSwipe = this.pageWidth / 2 < Math.abs(distance) && Math.abs(velocity) < 0.3
                        ...
                        ImageTouch.prototype.reset = function() {
                            this.pinList = []
                        ...
                        __decorate(
                            [
                                (0, _vuePropertyDecorator.Prop)(), // 图片数据源
                            ],
                            ImageTouch.prototype,
                            'imageList',
                            void 0
                        )
                        ...
                        ImageTouch = __decorate([_vuePropertyDecorator.Component], ImageTouch)
                        return ImageTouch
                    })(_vuePropertyDecorator.Vue)

                var _default = ImageTouch
                exports.default = _default
                var $00878f = exports.default || module.exports

                if (typeof $00878f === 'function') {
                    $00878f = $00878f.options
                }
                                      ...
                                      [
                                          _c(
                                              'div',
                                              {
                                                  ...
                                                  class: [_vm.isShow ? 'zoomIn' : 'zoomOut'],
                                                  on: {
                                                      click: function($event) {
                                              ...
                                              [
                                                  _c('div', { staticClass: 'image-touch-hd' }, [
                                                      _c('div', {
                                                      ...
                                                      _c(
                                                          'div',
                                                          {
                                                              ...
                                                              style: {
                                                                  ...
                                                                  width: _vm.touchWrapWidth + 'px',
                                                                  left: _vm.touchWrapLeft + 'px',
                                                              },
                                                          },
                                                              ...
                                                              return _c(
                                                                  ...
                                                                  [
                                                                      _c('img', {
                                                                          ...
                                                                          attrs: { src: item, alt: 'touch image' },
                                                                      }),
                                                                  ]
                                                              )
                                                          }),
                ...
                ;(function() {
                    if (module.hot) {
                        ...
                        if (api.compatible) {
                            module.hot.accept()
                            if (!module.hot.data) {
                                api.createRecord('$00878f', $00878f)
                            } else {
                                api.reload('$00878f', $00878f)
                            }
                        }
            ...
            {
                'vue-touch': '../node_modules/vue-touch/dist/vue-touch.js',
                'vue-property-decorator': '../node_modules/vue-property-decorator/lib/vue-property-decorator.js',
                _css_loader: '../node_modules/parcel-bundler/src/builtins/css-loader.js',
                'vue-hot-reload-api': '../node_modules/vue-hot-reload-api/dist/index.js',
                vue: '../node_modules/vue/dist/vue.runtime.esm.js',
        ...
        '../src/index.ts': [
            function(require, module, exports) {
                ...
                var _imageTouch = _interopRequireDefault(require('./image-touch.vue'))
                ...
                var ImageTouch = {
                    install: function install(Vue, options) {
                        var imageTouchContructor = Vue.extend(_imageTouch.default)
                        var imageTouchInstance

                        var initInstance = function initInstance() {
                            imageTouchInstance = new imageTouchContructor()
                            var dom = imageTouchInstance.$mount().$el
                            document.body.appendChild(dom) // 将dom插入body
                        }

                        Vue.prototype.$imageTouch = function(args) {
            ...
            { './image-touch.vue': '../src/image-touch.vue' },
        ],
        'index.ts': [
            function(require, module, exports) {
                'use strict'
